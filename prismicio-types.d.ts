...
export interface HeroSliceDefaultPrimary {
  ...
  /**
   * Tag Line 1 field in *Hero → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.default.primary.tag_line_1
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  tag_line_1: prismic.KeyTextField;
  ...
  /**
   * Tag Line more field in *Hero → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.default.primary.tag_line_more
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  tag_line_more: prismic.KeyTextField;
}
